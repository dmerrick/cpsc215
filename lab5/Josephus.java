 ...
 * File: Josephus.java
 *
 * As an example of a round robin scheduler, this program implements a 
 * solution to the Josephus problem using a queue.
 */
...
public class Josephus {
  ...
  public static <E> E Josephus(Queue<E> Q, int k) {
    ...
    while (Q.size() > 1) {
      ...
      E e = Q.dequeue();         // remove the front element 
